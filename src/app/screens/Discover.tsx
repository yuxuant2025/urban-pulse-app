...
const places: DiscoverPlace[] = [
  {
    id: '4', // Matches The Botanical Gardens in data.ts
  ...
  {
    id: '5', // Matches Midnight Cafe in data.ts
    name: 'Midnight Cafe',
